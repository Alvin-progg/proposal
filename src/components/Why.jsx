...
const Why = () => {
  return (
    <section className="w-full overflow-hidden flex justify-center items-center bg-bg1-50">
      <div className="flex flex-col mt-8">
        ...
        <h2 className="text-4xl font-semibold">Why Choose Blueket For Web Development?</h2>
      </div>
