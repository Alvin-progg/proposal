...
const Hero = () => {
  return (
    <section className='h-screen w-screen  justify-center flex items-center '>
        <div className='flex flex-col justify-start w-[50vw] px-8 gap-8 md:-ml-[30vh]'>
            ...
            <p className='text-xl lg:w-[30vw]  '>A full-service digital marketing firm that specialises in human-centered experiences. We bring  companies and people together</p>
            <div>
