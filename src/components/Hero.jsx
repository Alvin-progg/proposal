        ...
        <div className='flex flex-col justify-center items-start w-full max-w-7xl mx-auto relative z-10 text-white px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 gap-4 sm:gap-6 md:gap-8'>
            ...
            <div className="mt-2 sm:mt-4 md:mt-6">
                <a 
                  ...
                  className="relative inline-flex gap-2 sm:gap-3 p-3 sm:p-4 px-4 sm:px-6 md:px-8 bg-indigo-500 text-white items-center rounded-full overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl group text-sm sm:text-base md:text-lg font-semibold"
                >
                  <span className="relative z-10 flex gap-2 sm:gap-3 items-center">
                    Get Started 
                    <CgArrowTopRight  />
                  </span>
                  <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-indigo-600 transform -translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out"></div>
                </a>
            </div>
        </div>
    </section>
