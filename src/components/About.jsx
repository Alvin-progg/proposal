...
const About = () => {
  ...
  return (
    <section className='w-full  h-[660px] bg-serv-1 my-10 flex justify-center items-center overflow-x-hidden max-sm:h-[1035px]  '>
      <div className='h-[460px] w-full flex justify-center my-auto max-lg:flex-col  '>
        <div className='w-[770px] mx-4 -mt-4 max-sm:h-[582px] '>
