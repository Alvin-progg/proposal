    ...
    <div className="m-0 p-0 relative">
      ...
      >
        ...
        <ul className="hidden xl:flex items-center gap-6 text-lg xl:gap-8 xl:text-xl">
          <li><a href="#" className=" transition-colors" aria-label='demo'>Demo</a></li>
          <li><a href="#" className=" transition-colors" aria-label='about'>About Us</a></li>
          <li><a href="#" className=" transition-colors" aria-label='Service'>Services</a></li>
          <li><a href="#" className=" transition-colors" aria-label='portfolio'>Portfolio</a></li>
          <li><a href="#" className=" transition-colors" aria-label='Blog'>Blog</a></li>
          <li><a href="#" className=" transition-colors" aria-label='contact'>Contact Us</a></li>
        </ul>
